...
/**
 * This code will play any song assuming that file is in folder song files. 
 * 
...
public class PlayAnMP3 extends Application {
  ...
  public void start(Stage stage) throws Exception {
    ...
    // I, Duke Speed, changed the song to be played before pushing to GitHub
    String path = "songfiles/DanseMacabreViolinHook.mp3";
    // And swapped a few lines, in addition to changing a few typos.
    playASong(path);
